...
export const config = {
  ...
  dexScreenerMaxTokens: numberFromEnv('DEXSCREENER_MAX_TOKENS', 30),
  newPairDefaultAgeMinutes: numberFromEnv('NEW_PAIR_DEFAULT_AGE_MINUTES', 60),
  newPairFreshMinLiquidityUsd: numberFromEnv('NEW_PAIR_FRESH_MIN_LIQUIDITY_USD', 5_000),
  ...
  marketQualityFreshMinLiquidityUsd: numberFromEnv('MARKET_QUALITY_FRESH_MIN_LIQUIDITY_USD', 5_000),
